...
describe Project do
  ...
  describe '#volunteers' do
    it 'returns all volunteers for a specific project' do
      project = Project.new({:title => 'Teaching Kids to Code', :id => nil})
      project.save
      volunteer1 = Volunteer.new({:name => 'Jasmine', :project_id => project.id, :hours => 50, :id => nil})
      volunteer1.save
      volunteer2 = Volunteer.new({:name => 'Joe', :project_id => project.id, :hours => 1, :id => nil})
      volunteer2.save
  ...
  describe '#volunteers_sort' do
    it 'returns all volunteers for a specific project sorted alphabetically' do
      project = Project.new({:title => 'Teaching Kids to Code', :id => nil})
      project.save
      volunteer1 = Volunteer.new({:name => 'Martha', :project_id => project.id, :hours => 3, :id => nil})
      volunteer1.save
      volunteer2 = Volunteer.new({:name => 'Andy', :project_id => project.id, :hours => 6, :id => nil})
      volunteer2.save
  ...
  describe '#hours' do
    it 'returns total number of volunteer hours for' do
      project = Project.new({:title => 'Teaching Kids to Code', :id => nil})
      project.save
      volunteer1 = Volunteer.new({:name => 'Martha', :project_id => project.id, :hours => 10, :id => nil})
      volunteer1.save
      volunteer2 = Volunteer.new({:name => 'Andy', :project_id => project.id, :hours => 6, :id => nil})
      volunteer2.save
  ...
  describe '#hours' do
    it 'returns the number of hours for a specific project' do
      project = Project.new({:title => 'Teaching Kids to Code', :id => nil})
      project.save
      volunteer1 = Volunteer.new({:name => 'Martha', :project_id => project.id, :hours => 7, :id => nil})
      volunteer1.save
